...
$itemPrice = get_post_meta($buyId, 'discount_price',true);
$currency   = deals_get_option('currency');

$option_paypal = deals_get_option('paypal_email');
$option_enable_sandbox = deals_get_option('paypal_is_test');
$option_sandbox = deals_get_option('paypal_sandbox_email');

$ipn = plugins_url('deals-payments/paypal/paypal_ipn.php?item_id='.$buyId.'&user_id='.$current_user->ID,DEALS_PLUGIN_FILE);
