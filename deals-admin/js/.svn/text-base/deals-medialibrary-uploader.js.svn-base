...
/*-----------------------------------------------------------------------------------*/
    ...
    removeFile: function () {
     ...
     $('.mlu_remove').live('click', function(event) { 
        ...
        $(this).parents('.screenshot').siblings('.deals-background-properties').hide(); //remove background properties
        return false;
      });
...
/*-----------------------------------------------------------------------------------*/
	...
	window.send_to_editor = function(html) {
		...
		if (formfield) {
		  ...
		  $('#' + formfield).siblings('.deals-background-properties').show(); //show background properties
          tb_remove();
  ...
  }; // End dealsframeworkMLU Object // Don't remove this, or the sky will fall on your head.

/*-----------------------------------------------------------------------------------*/
/* Execute the above methods in the dealsframeworkMLU object.
/*-----------------------------------------------------------------------------------*/
  
	$(document).ready(function () {

		dealsframeworkMLU.removeFile();
		dealsframeworkMLU.recreateFileField();
		dealsframeworkMLU.mediaUpload();
